...
<script setup>
import TheHero from "@/components/pages/LandingPage/TheHero.vue";
...
import TheBenefits from "@/components/pages/LandingPage/TheBenefits.vue";
import BannerForm from "@/components/pages/LandingPage/BannerForm.vue";
</script>
